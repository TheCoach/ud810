...
[corners, R] = find_harris_corners(harris_check_rot, 0.5, 5);
...
harris_transA = compute_harris_value(img_transA);
% show harris values
...
[corners, ~] = find_harris_corners(harris_transA, 0.1, 15);
...
harris_transB = compute_harris_value(img_transB);
% show harris values
...
[corners, ~] = find_harris_corners(harris_transB, 0.1, 15);
